...
class MusicRecommender:
    def __init__(self, csv_path):  # Correct constructor definition
        ...
        # Handle missing 'release_date' or 'Album/Movie' column
        if 'release_date' in self.df.columns:
            self.df['Album/Movie'] = self.df['release_date'].astype(str).str.replace(' ', '')
        else:
            self.df['Album/Movie'] = ''
